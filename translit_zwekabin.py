...
# Zwekabin font encoding conversion to Unicode form

Description = ZWEKABIN_description = u'Zwekabin font encoding conversion'

TRANS_LIT_RULES = ZWEKABIN_UNICODE_TRANSLITERATE = u"""# 
$nondigits = [^\u1040-\u1049];
$space = '\u0020';
$consonant = [\u1000-\u1021];
$vowelsign = [\u102B-\u1030\u1032];

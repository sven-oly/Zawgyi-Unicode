...
Description = MON2012_description = u'Mon font encoding conversion'
TRANS_LIT_RULES = MON2012_TRANSLITERATE = u"""#
$nondigits = [^\u1040-\u1049];
$space = '\u0020';
$consonant = [\u1000-\u1021];
$vowelsign = [\u102B-\u1030\u1032];
...
description = 'First try for transliteration rules for Mon 2012 to Unicode'

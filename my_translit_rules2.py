...
ZAWGYI_UNICODE_TRANSLITERATE_2 = """# Modern Burmese digits & Unicode code points.
$nondigits = [^\u1040-\u1049];
$consonant = [\u1000-\u1021];
...
([\u103D\u103E]) \u103C > \u103C $1;
\u103E\u103D > \u103D\u103E ;
# Move virama sign relative to vowel signs, etc.
([\u102f\u1030]) \u103a > \u103a $1;
\u104b \u103a > \u103a \u104b;
# Move visarga (\u1038) after other signs
\u1038 ([$vowelmedial]) > $1 \u1038;
\u1038 ([\u1036\u1037\u103A]) > $1 \u1038;
# Fix Space before final modifiers.
\u0020 ([\u1036-\u1038]) > $1 \u0020;
###
### Stage 6
...
($consonant) \u103B \u103A > $1 \u103A \u103B;
# Sort the medials one last time.
([\u103C\u103D\u103E]) \u103B > \u103B $1;
([\u103D\u103E]) \u103C > \u103C $1;
\u103E\u103D > \u103D\u103E ;
# Remove extra asats
...
\u102F \u103A > \u102F;
# Fix conflicting vowel signs
\u102D \u102E > \u102E;
\u102F \u1030 > \u102F;
# Remove extra copy of diacritics
\u102B [\u102B]+ > \u102B;
\u102C [\u102C]+ > \u102C;
\u102D [\u102D]+ > \u102D;
\u102E [\u102E]+ > \u102E;
...
\u103D [\u103D]+ > \u103D;
\u103E [\u103E]+ > \u103E;
# Lone diacritics after a space.
\u0020([\u102b-\u103f]) > \u00A0 $1;
"""

date_entered = '11-June-2015'
description = 'Second pass at rules for converting Zawgyi to Unicode'
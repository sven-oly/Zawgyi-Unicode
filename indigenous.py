...
Language = 'Indigenous'
Language_native = 'Indigenous languages'

encoding_font_list = [
    {
      'font_path':'/fonts/NotoSansMyanmar-Regular.ttf',
...
# Shows keyboard for Myanmar languages
class ChakmaIndigenousHomeHandler(webapp2.RequestHandler):
    def get(self):

      kb_list = [
        {'shortName':  'my',
         'longName': 'Burmese MM3'
        },
        {'shortName':  'shn',
